...
class FactMasteryDaoTest {
    ...
    @Test
    fun upsertAndGetFactMasteryMastery() {
        runBlocking {
            ...
            retrievedFactMastery?.strength shouldBe factMastery.strength
            ...
            updatedRetrievedFactMastery?.strength shouldBe updatedFactMastery.strength
        }
    }
}
